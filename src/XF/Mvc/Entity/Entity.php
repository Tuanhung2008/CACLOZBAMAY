...
abstract class Entity implements \ArrayAccess
{
	...
	public function isRelationHydrated(string $key): bool
	{
	...
	protected function _deleteFromSource(): int
	{
		return $this->db()->delete($this->_structure->table, $this->_getUpdateCondition());
	}

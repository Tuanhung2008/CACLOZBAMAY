...
use function defined, get_class, intval, is_array, is_object, is_string, ord, strlen, strval;
...
class Php
{
	...
	public static function getEnvironmentReport()
	{
		$env = [
			...
			'mbstring' => function_exists('mb_split'),
		...
		if (version_compare($env['phpVersion'], '8.2.0', '>='))
		{
